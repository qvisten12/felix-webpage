  ...
  return (
    <div className="container max-w-5xl w-full mx-auto px-4 md:px-10 mb-10 md:mb-16">
      ...
      <div className="flex flex-col">
        <div className="flex flex-col md:flex-row mt-10 justify-between items-center mb-10">
        ...
        <div className="flex items-center justify-center text-gray-600 font-light tracking-wider">
          Built with Next.js
        </div>
      </div>
    </div>
